...
#define HID_POWER_UNIT_TEMPERATURE       0x67, 0x01, 0x00, 0x01, 0x00, 0x55, 0x00 /**Temperature unit code. K degree.*/
#define HID_POWER_UNIT_BATTERY_CAPACITY  0x67, 0x01, 0x10, 0x10, 0x00, 0x55, 0x00 /**Battery capacity unit code. AmpSec.*/
