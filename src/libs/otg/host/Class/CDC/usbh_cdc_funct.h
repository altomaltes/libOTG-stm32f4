...
{
  byte Array[LINE_CODING_STRUCTURE_SIZE];
...
typedef struct _FunctionalDescriptorHeader
{
  ...
  byte     bDescriptorType;    /*CS_INTERFACE (0x24)*/
  byte     bDescriptorSubType; /* Header functional descriptor subtype as*/
...
typedef struct _CallMgmtFunctionalDescriptor
{
  ...
  byte    bDataInterface;      /*bDataInterface: 1*/
}
...
typedef struct _AbstractCntrlMgmtFunctionalDescriptor
{
  byte    bLength;            /*Size of this functional descriptor, in bytes.*/
  byte    bDescriptorType;    /*CS_INTERFACE (0x24)*/
  byte    bDescriptorSubType; /* Abstract Control Management functional
                                  descriptor subtype*/
...
typedef struct _UnionFunctionalDescriptor
{
  ...
  byte    bMasterInterface;   /* The interface number of the Communication or
                                 Data Class interface,*/
